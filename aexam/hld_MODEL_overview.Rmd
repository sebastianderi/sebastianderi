...
All of the above presupposes that we have trained our model on a certain portion
of our data and then tested it on a separate portion of our data. However, there
are actually any way to conduct this split.

The golden rule in predictive modeling is to never use the same data that the model was built on to
