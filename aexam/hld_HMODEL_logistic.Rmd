...
results <- results_HYB_log # change the specific named (renamed at end), back to generic name
...
```{r make_example_models, cache = FALSE, eval = FALSE}
# set seed, so that statistics don't keep changing for every analysis
