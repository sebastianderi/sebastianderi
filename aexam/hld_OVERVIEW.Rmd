...
We are less focused here on explanation. And our question is more akin to one
about group decision making. However, here the groups consist not of the combination
of different people but of the combination of different decision making agents:
humans and computers. I believe that the resources of these different agents can
be combined for more effective lie detection than either one is capable of alone.
I believe this becuase all that is requred for a such a result is for the following
conditions to hold: (1) computer models can be trained to predict lies better than
chance, (2) humans can make predict lies better than chance, (3) the basis of these
two predictions (computer and human predictions) are independent. This latter
condition seems especially likely to be true, to me. Our computer models will
be trained on very rudimentary textual features, while our humans will make
judgements based on their knowledge of the word and personal experience (e.g. 
"why would a person in that situation do that? seems like a lie") -- something
which our computers certain do not have.
...
* Computer Performance
    ...
    + Modeling
        ...
        + [Support Vector Machines](./hld_MODEL_svm.html)
...
* Hybrid Performance
    + [Logistic Regression Hybrid Model](./hld_MODEL_logistic.html)
    + [Support Vector Machine Hybrid Model](./hld_MODEL_svm.html)
    + [Neural Network Hyrbid](/.hld_MODEL_neural.html)
    + [Comparison of All Hybrid Models](./hld_MODEL_comparison.html)
